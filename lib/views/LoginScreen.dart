...
import 'package:login_screen/views/SignUpScreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
        ...
        SizedBox(
          ...
          child: Padding(
            ...
            child: InkWell(
              ...
              onTap: _createAccountButtonTapped,
            ),
          ),
        )
      ],
  ...
  _forgetButtonTapped() {
    ...
    Navigator.push(
        context,
        kIsWeb?FadeRoute(page: ForgetPasswordScreen()):EnterExitRoute(enterPage: ForgetPasswordScreen()));
  }

  _createAccountButtonTapped(){
    Navigator.push(
        context,
        kIsWeb?FadeRoute(page: SignUpScreen()):EnterExitRoute(enterPage: SignUpScreen()));
